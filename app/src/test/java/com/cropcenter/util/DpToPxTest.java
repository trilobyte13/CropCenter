 ...
 * regression is `(int) (1 * 0.75f)` truncating to 0, making 1dp dividers and 1px tick marks invisible on density-0.75
 * screens. The Math.round path keeps 1dp at 1px there.
 */
public final class DpToPxTest
{
	...
	{
		// 3 * 1.5 = 4.5 — Math.round picks 5 (round-half-up). Truncation would give 4.
