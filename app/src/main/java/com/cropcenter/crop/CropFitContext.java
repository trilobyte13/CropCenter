 ...
 */
record CropFitContext(double cosR, float halfHeight, float halfWidth, float imageMidX, float imageMidY,
	int imgH, int imgW, double sinR)
{
	 ...
	 */
	static CropFitContext of(int cropW, int cropH, float rotationDegrees, int imgW, int imgH)
	{
