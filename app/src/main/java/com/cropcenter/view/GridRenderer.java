...
/**
 * Draws grid overlay lines within the crop rectangle.
 * Grid lines are snapped to image pixel boundaries so they sit ON pixels,
 * not between them. This is computed in image space then converted to screen space.
 */
