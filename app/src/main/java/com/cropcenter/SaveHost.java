 ...
 * (clearTransientDialog, SaveAs launcher, setActiveTransientDialog) on top of the common EditorHost plumbing
 * (busy + progress + toast + registerTransientDialog moved there to remove duplication with ToolbarHost).
 */
interface SaveHost extends EditorHost
{
	...
	/**
	 * The Activity-registered SAF launcher for the ACTION_CREATE_DOCUMENT save-as flow. Must be registered
	 * in onCreate (Activity contract — registerForActivityResult after START throws) and surfaced here so
